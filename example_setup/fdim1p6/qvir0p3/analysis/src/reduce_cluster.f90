subroutine reduce_cluster(snapshoti,ni)
...
!ToDo:
!----This projection stuff can go in a loop. If i=1 projection='xy' etc----
...
!======!
  ...
  unit1 = unit1 + 2
  unit2 = unit2 + 2
  open(unit1,file=trim(outarg)//'/'//trim(newDir)//'/objm_lambar_xz.txt')
  open(unit2,file=trim(outarg)//'/'//trim(newDir)//'/objescaped_lambar_xz.txt')
  ...
  unit1 = unit1 + 2
  unit2 = unit2 + 2
  open(unit1,file=trim(outarg)//'/'//trim(newDir)//'/objm_lamtilde_xz.txt')
  open(unit2,file=trim(outarg)//'/'//trim(newDir)//'/objescaped_lamtilde_xz.txt')

  write(6,*)"       Calculating tilde..."
  do i=1,snapnum
     call find_lambda_tilde(i,nstars(i))
  end do
  ...
  unit1 = unit1 + 2
  unit2 = unit2 + 2
  open(unit1,file=trim(outarg)//'/'//trim(newDir)//'/objm_lamstar_xz.txt')
  open(unit2,file=trim(outarg)//'/'//trim(newDir)//'/objescaped_lamstar_xz.txt')
  ...
  unit1 = unit1 + 2
  unit2 = unit2 + 2
  open(unit1,file=trim(outarg)//'/'//trim(newDir)//'/objm_gam_xz.txt')
  open(unit2,file=trim(outarg)//'/'//trim(newDir)//'/objescaped_gam_xz.txt')
...
!======!
  ...
  open(unit2,file=trim(outarg)//'/'//trim(newDir)//'/objescapedp_lamstar_3D.txt')
  ...
  open(unit2,file=trim(outarg)//'/'//trim(newDir)//'/objescapedp_gam_3D.txt')
