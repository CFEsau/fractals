...
outpath <- paste0('/local/cfe/backed_up_on_astro3/fractals/r1p0/',fbin,
                  '/',fdim,qvir,'/analysis')

#output directory for stats-related plots
statsdir <- file.path(outpath,"stats")
...
for (k in 1:10) {
  ...
  #update knum'th row of data frame with % agreement for each method
...
png(filename=paste0(statsdir,"/boxplot_f",fdim,"q",qvir,".png"))
